...
public class TestGetPaymentData {
	 ...
	 public void testGetPaymentInfo() throws Exception {
	     ...
	     CloseableHttpResponse response = this.abstractVisaAPIClient.doXPayTokenRequest(baseUri, resourcePath, "apikey=" + this.apiKey, "Get Payment Information Test", "", MethodTypes.GET, new HashMap<String, String>());
