...
class PaymentAccountValidationTest extends HttpClient {
	...
	public function testCardValidation() {
		...
		$statusCode = $this->doMutualAuthCall ( 'post', $baseUrl.$resourcePath, 'Card Validation call', $this->paymentAccountValidation );
