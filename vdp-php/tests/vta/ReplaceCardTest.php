...
class ReplaceCardTest extends HttpClient {
	...
	public function testReplaceCards() {
		...
		$statusCode = $this->doMutualAuthCall( 'post', $baseUrl.$resourcePath, 'Replace a card test', $this->replaceCardsRequest, array("ServiceId: ".$this->conf['VDP'] ['vtaServiceId'] ));
