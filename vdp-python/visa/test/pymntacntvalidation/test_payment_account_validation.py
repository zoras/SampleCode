...
class TestPaymentAccountValidation(VDPTestCaseClient):
    ...
    def test_enrollement(self):
        ...
        response = self.do_mutual_auth_request(base_uri + resource_path, self.payment_account_validation, 'Card Validation call', 'post')
