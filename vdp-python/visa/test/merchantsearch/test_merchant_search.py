...
class TestMerchantSearchAPI(VDPTestCaseClient):
    ...
    def test_merchant_search_API(self):
        ...
        response = self.do_mutual_auth_request(base_uri + resource_path, self.locator_request, 'Merchant Search Test', 'post')
