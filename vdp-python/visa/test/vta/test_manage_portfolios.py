...
class TestManagePortfolios(unittest.TestCase):
    ...
    def test_portfolios(self):
        ...
        response = self.abstract_visa_api_client.do_mutual_auth_request(base_uri + resource_path, '', 'Get Portfolio Details Test', 'get', {'ServiceId' : self.config.get('VDP','vtaServiceId')})
